...
public class SplashActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!Config.isNetworkAvailable(SplashActivity.this)) {
            Dialog_new dialog_wifi_settings = new Dialog_new(SplashActivity.this, "No Network Avaliable!\nGo to Settings.", 5);
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                if (jsonobject.toString() == "sam") {
                    Dialog_Msg dialog_fail = new Dialog_Msg(SplashActivity.this, "Please Try Again Later.");
    ...
    class GetVersion extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String jsonStr) {
            ...
            try {
                ...
                e.printStackTrace();
                Dialog_Msg dialog_fail = new Dialog_Msg(SplashActivity.this, "Network Error,Please Try Again Later.");
                dialog_fail.getWindow().requestFeature(Window.FEATURE_NO_TITLE);
                dialog_fail.show();
            }
        }
