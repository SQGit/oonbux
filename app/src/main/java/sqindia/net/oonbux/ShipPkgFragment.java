...
public class ShipPkgFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View getView = inflater.inflate(R.layout.fragment_ship_package, container, false);
  ...
  /*      tv_ship_tke_pic_nm = (TextView) getView.findViewById(R.id.txt_1);
      ...
      /*  tv_ship_tke_pic_nm.setTypeface(tf);
        ...
        b1 = (Button) getView.findViewById(R.id.tbtn1);
        b2 = (Button) getView.findViewById(R.id.tbtn2);

     /*   b1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                b1.setTextColor(getResources().getColor(R.color.colorAccent));
                b2.setTextColor(getResources().getColor(R.color.text_color_hint_light));
            }
        });
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                b1.setTextColor(getResources().getColor(R.color.text_color_hint_light));
            }
        });*/
