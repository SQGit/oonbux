...
public class Register extends AppCompatActivity {
    ...
    ViewPager.OnPageChangeListener viewPagerPageChangeListener = new ViewPager.OnPageChangeListener() {
        ...
        public void onPageSelected(int position) {
            ...
            if (position == 0) {
                ...
                if (!(sharedPreferences.getString("reg_email", "").equals(""))) {

                    MaterialEditText et = (MaterialEditText) viewPager.findViewById(R.id.edittext_fname);
                    MaterialEditText et1 = (MaterialEditText) viewPager.findViewById(R.id.edittext_lname);
                    MaterialEditText et2 = (MaterialEditText) viewPager.findViewById(R.id.edittext_email);
                    et.setText(sharedPreferences.getString("reg_fname", ""));
                    et1.setText(sharedPreferences.getString("reg_lname", ""));
                    et2.setText(sharedPreferences.getString("reg_email", ""));
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sharedPreferences = PreferenceManager.getDefaultSharedPreferences(Register.this);
        ...
        btn_submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                bundle.putString(FirebaseAnalytics.Param.ITEM_ID, str_phone);
                bundle.putString(FirebaseAnalytics.Param.ITEM_NAME, str_email);
                bundle.putString(FirebaseAnalytics.Param.CONTENT_TYPE, "reg_email");
            ...
            if (position == 0) {
                ...
                tv_manual.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Dialog_Region dialog_region = new Dialog_Region(Register.this);
    ...
    class RegisterTask extends AsyncTask<String, Void, String> {
        protected void onPreExecute() {
            ...
            /*loading_dialog = new Dialog(Register.this);
            ...
            dialog_loading = new Dialog_Anim_Loading(Register.this);
            ...
            if (s != null) {
                try {
                    ...
                    if (status.equals("success")) {
                        ...
                        Dialog_new dialog_reg_success = new Dialog_new(Register.this, sus_txt, 0);
                        ...
                        Dialog_Msg dialog_reg_fail = new Dialog_Msg(Register.this, msg);
                    ...
                    e.printStackTrace();
                    Dialog_Msg dialog_fail = new Dialog_Msg(Register.this, "Network Error,Please Try Again Later.");
