...
//        bb.setTypeface(tf);
        ...
        Log.e("tag", "decode" + dbc.get_ship_img());
        ...
        imageData = dbc.get_ship_img();


        byte[] imageAsBytes = Base64.decode(imageData, Base64.DEFAULT);

        iv_ship_img.setImageBitmap(BitmapFactory.decodeByteArray(imageAsBytes, 0, imageAsBytes.length));
