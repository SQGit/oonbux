...
public class Pal_Pendings extends Fragment {

    ListView lv_palpendings;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.pal_pendings, container, false);

        final SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(getActivity());
        str_sessionid = sharedPreferences.getString("sessionid", "");


        lv_palpendings = (ListView) v.findViewById(R.id.lview);
