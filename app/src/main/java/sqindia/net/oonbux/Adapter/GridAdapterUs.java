...
public class GridAdapterUs extends BaseAdapter {
    ...
    public GridAdapterUs(Context context, ArrayList<HashMap<String, String>> datas) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            pos = sharedPreferences.getString("us","");
        ...
        cb_choose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (checkBox.isChecked()) {
                    ...
                    editor.putString("virtual_address1", result.get(AddLocation._id));
                    editor.putString("va1_line1", result.get(AddLocation.addr1));
                    editor.putString("va1_line2", result.get(AddLocation.addr2));
                    editor.putString("va1_city", result.get(AddLocation.city));
                    editor.putString("va1_state", result.get(AddLocation.state));
                    editor.putString("va1_zip", result.get(AddLocation.zip));
                    editor.putString("va1_country", result.get(AddLocation.country));
                    editor.putString("us",String.valueOf(position));
                    editor.commit();
